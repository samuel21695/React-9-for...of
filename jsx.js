...
function ReactComponent(props) {
  /*
    React에서 말하는 props 매개변수는 '반드시' 객체 타입이어야 한다는 약속이 있으므로 매개'변수' 보다는 무엇이 들어있을지 모르는 여러개의 값의 뭉치 '객체'로 보아야합니다.
  */
  ...
  */
  ...
  // return은 사실상 DOM API를 사용하는 것이 아니라, 리액트를 제공하는 createElement 함수를 사용합니다.
